...
/**
 * Created by zhaoyang on 2017/5/12.
 */
@Entity
public class MusicListSong {
    ...
    @Generated(hash = 1867830199)
    public MusicListSong(Long mc_id, String sn, String name, String mode,
    ...
    @Generated(hash = 796932623)
    public MusicListSong() {
    }
